...
import 'package:babyshophub/common/bloc/button/button_state.dart';
import 'package:babyshophub/common/bloc/button/button_state_cubit.dart';
import 'package:babyshophub/common/helper/bottomsheet/app_bottomsheet.dart';
...
import 'package:babyshophub/presentation/auth/bloc/age_selection_cubit.dart';
import 'package:babyshophub/presentation/auth/bloc/ages_display_cubit.dart';
import 'package:babyshophub/presentation/auth/bloc/gender_selection_cubit.dart';
import 'package:babyshophub/presentation/auth/widgets/ages.dart';
...
class GenderAndAgeSlectionScreen extends StatelessWidget {
  ...
  const GenderAndAgeSlectionScreen({required this.userCreationReq, super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: BasicAppbar(title: const Text('Gender and Age')),
